...
typedef void(^ScreenCaptureResponseBlock)(void);
typedef void(^ScreenCaptureErrorBlock)(NSError *);
...
@interface ScreenCaptureView : UIView {
    ...
    ScreenCaptureResponseBlock responseBlock;
    ScreenCaptureErrorBlock errorBlock;
