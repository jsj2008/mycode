...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    {
        NSLog(@"heree");
        firstrunLoader=[[FirstRun alloc]init];
        [firstrunLoader loadBirds];
        [[NSUserDefaults standardUserDefaults] setObject:[NSString stringWithFormat:@"YES"] forKey:@"FirstRun"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator {
    ...
    if (![persistentStoreCoordinator addPersistentStoreWithType:NSSQLiteStoreType configuration:nil URL:storeUrl options:nil error:&error1]) {
		/*
