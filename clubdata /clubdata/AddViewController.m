...
@implementation AddViewController {
    ...
    __weak IBOutlet UIBarButtonItem *edit;
}
@synthesize check;
...
- (IBAction)doDoneButton:(id)sender {
    ...
    UIAlertView *myAlertView=[[UIAlertView alloc] initWithTitle:@"Congratulations" message:@"User Added!!" delegate:self cancelButtonTitle:@"Ok" otherButtonTitles:nil, nil];
    [myAlertView show];
...
- (IBAction)editButton:(id)sender
{
    ...
    UIBarButtonItem *btnNewGame = [[UIBarButtonItem alloc] initWithTitle:@"Done" style:UIBarButtonItemStyleBordered
   ...
   mob.userInteractionEnabled=YES;
    bbm.userInteractionEnabled=YES;
    gender.userInteractionEnabled=YES;
    color.userInteractionEnabled=YES;
    bday.userInteractionEnabled=YES;
    
}
-(void) save
{
      User *userDetails=[fetchedObjects objectAtIndex:self.check];
    userDetails.email=email.text;
    userDetails.fname=fName.text;
    userDetails.lname=lName.text;
    userDetails.mobile=mob.text;
