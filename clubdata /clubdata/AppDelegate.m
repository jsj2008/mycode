...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    //set root and master view controllers
...
//
//    //array for temporary data store
//    list = [NSMutableArray arrayWithObjects: @"One", @"Two", @"Three", @"Four", nil];
//    
//    masterViewController.list = list;
